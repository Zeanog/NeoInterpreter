...
namespace Neo {
    [Serializable]
    public class SubtractInstruction : MultiTypeInstruction {
        public SubtractInstruction( Value lhs, Value rhs, Value ret ) : base( lhs, rhs, ret ) {
            BuildHandlers();
        }

        public SubtractInstruction( SerializationInfo info, StreamingContext context ) : base( info, context ) {
            BuildHandlers();
        }
